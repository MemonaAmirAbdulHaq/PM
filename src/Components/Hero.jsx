...
const Hero = () => {
  ...
  <div className="max-w-6xl mx-auto text-center">
    ...
    <div className="mt-12 flex flex-col sm:flex-row justify-center gap-4">
      ...
      <a
        href="https://drive.google.com/file/d/1O1udaHY5hPBT7Q-qcqzy3yTu7TJAnHqd/view"
        target="_blank"
        rel="noreferrer"
        className="
          px-8
    ...
    {/* Bottom accent */}
    <div className="mt-20 flex justify-center">
      <div className="h-px w-48 bg-gradient-to-r from-transparent via-cyan-500 to-transparent" />
    </div>
